...
namespace RenderTextureConverting
{
    public class RenderTextureConverterV2
    {
        ...
        public Texture2D ConvertRenderTexture2DToTexture2D(RenderTexture renderTexture2D, bool generateMips = false, bool readable = false)
        {
        ...
        public void SaveRenderTexture2DAsTexture2D(RenderTexture renderTexture2D, string assetRealtivePath, bool generateMips = false, bool readable = false)
        {
            Texture2D converted = ConvertRenderTexture2DToTexture2D(renderTexture2D, generateMips, readable);
