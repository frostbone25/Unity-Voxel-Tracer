    ...
    public class CameraMetaPassV2 : MonoBehaviour
    {
        ...
        public void RenderAllMeshesNormally()
        {
            ...
            using (CommandBuffer sceneAlbedoCommandBuffer = new CommandBuffer())
            {
                ...
                sceneAlbedoCommandBuffer.SetRenderTarget(scenePackedMetaBuffer);
                sceneAlbedoCommandBuffer.SetViewProjectionMatrices(viewMatrix, camera.projectionMatrix);
                sceneAlbedoCommandBuffer.SetViewport(new Rect(0, 0, scenePackedMetaBuffer.width, scenePackedMetaBuffer.height));
                    ...
                    //if (objectMetaData.materials != null)
                    {
                        ...
                        for (int j = 0; j < objectMetaData.materials.Length; j++)
                        {
                            ...
                            if (materialMetaData.isEmpty() == false)
                            {
                                ...
                                materialPropertyBlock.SetTexture("_MainTex", materialMetaData.packedMetaBuffer);
            ...
            dataPacking.SetTexture(ComputeShader_DataUnpacking64, "EmissiveBuffer", sceneEmissive);
            dataPacking.SetTexture(ComputeShader_DataUnpacking64, "NormalBuffer", sceneNormal);
