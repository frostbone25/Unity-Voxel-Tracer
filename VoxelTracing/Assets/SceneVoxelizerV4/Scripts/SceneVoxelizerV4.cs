...
namespace SceneVoxelizer4
{
    public class SceneVoxelizerV4 : MonoBehaviour
    {
        ...
        private ComputeShader dataPacking;
        ...
        public List<ObjectMetaData> BuildMetaObjectBuffers()
        {
            ...
            RenderTextureFormat intermediateFormat = RenderTextureFormat.ARGBFloat; //128 bits
            ...
            for (int i = 0; i < meshRenderers.Length; i++)
            {
                ...
                //if(ContainBounds(voxelBounds, meshRenderer.bounds))
                //continue; //skip to the next iteration in the loop.
                    ...
                    using (CommandBuffer metaDataCommandBuffer = new CommandBuffer())
                    {
                        ...
                        for (int j = 0; j < materials.Length; j++)
                        {
                            ...
                            if (metaPassIndex != -1)
                            {
                                ...
                                meshPackedBuffer.wrapMode = TextureWrapMode.Clamp;
                                ...
                                dataPacking.SetTexture(ComputeShader_DataPacking64, ShaderIDs.Write, meshPackedBuffer);
        ...
        public void GenerateAlbedoEmissiveBuffers()
        {
            ...
            RenderTextureFormat intermediateFormat = RenderTextureFormat.ARGB64; 
            RenderTextureFormat packedFormat = RenderTextureFormat.ARGB64;
            ...
            RenderTexture combinedSceneVoxel = new RenderTexture(voxelResolution.x, voxelResolution.y, 0, packedFormat);
            ...
            using (CommandBuffer sceneAlbedoCommandBuffer = new CommandBuffer())
            {
                ...
                RenderTexture voxelCameraSlice = new RenderTexture(voxelResolution.z, voxelResolution.y, renderTextureDepthBits, packedFormat);
                ...
                voxelCameraSlice = new RenderTexture(voxelResolution.x, voxelResolution.z, renderTextureDepthBits, packedFormat);
                //voxelCameraSlice.antiAliasing = enableAnitAliasing ? 8 : 1;
                voxelCameraSlice.filterMode = combinedSceneVoxel.filterMode;
                voxelCameraSlice.wrapMode = combinedSceneVoxel.wrapMode;
                voxelCameraSlice.enableRandomWrite = true;
                ...
                voxelCameraSlice = new RenderTexture(voxelResolution.x, voxelResolution.y, renderTextureDepthBits, packedFormat);
                //voxelCameraSlice.antiAliasing = enableAnitAliasing ? 8 : 1;
                voxelCameraSlice.filterMode = combinedSceneVoxel.filterMode;
                voxelCameraSlice.wrapMode = combinedSceneVoxel.wrapMode;
                voxelCameraSlice.enableRandomWrite = true;
            ...
            RenderTexture sceneAlbedo = new RenderTexture(voxelResolution.x, voxelResolution.y, 0, RenderTextureFormat.ARGB32);
            RenderTexture sceneEmissive = new RenderTexture(voxelResolution.x, voxelResolution.y, 0, RenderTextureFormat.ARGBHalf);
            RenderTexture sceneNormal = new RenderTexture(voxelResolution.x, voxelResolution.y, 0, RenderTextureFormat.ARGB32);

            sceneAlbedo.dimension = TextureDimension.Tex3D;
            sceneAlbedo.filterMode = combinedSceneVoxel.filterMode;
            ...
            sceneEmissive.filterMode = combinedSceneVoxel.filterMode;
            ...
            sceneNormal.filterMode = combinedSceneVoxel.filterMode;
            ...
            //Texture3D convertedSceneAlbedo = RenderTextureConverter.ConvertFromRenderTexture3D(slicer, sceneAlbedo, TextureFormat.RGBA32);
            //Texture3D convertedSceneNormal = RenderTextureConverter.ConvertFromRenderTexture3D(slicer, sceneNormal, TextureFormat.RGBA32);
            //Texture3D convertedSceneEmissive = RenderTextureConverter.ConvertFromRenderTexture3D(slicer, sceneEmissive, TextureFormat.RGBAHalf);
            //Texture3D test = RenderTextureConverter.ConvertFromRenderTexture3D(slicer, combinedSceneVoxel, TextureFormat.RGBAFloat);
            ...
            //SaveVolumeTexture(string.Format("SceneVoxelizerV4_{0}_albedo", voxelName), convertedSceneAlbedo);
            //SaveVolumeTexture(string.Format("SceneVoxelizerV4_{0}_emissive", voxelName), convertedSceneEmissive);
            //SaveVolumeTexture(string.Format("SceneVoxelizerV4_{0}_normal", voxelName), convertedSceneNormal);
            //SaveVolumeTexture(string.Format("SceneVoxelizerV4_{0}_test", voxelName), test);
