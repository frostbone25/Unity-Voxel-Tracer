...
namespace MetaPassRenderingV1
{
    public class MetaPassRenderingV1
    {
        ...
        private static string localAssetFolder = "Assets/MetaPassRenderingV1";
        private static string localAssetShadersFolder = "Assets/MetaPassRenderingV1/Shaders";
        private static string dilateAssetPath = "Assets/MetaPassRenderingV1/Shaders/Dilation.compute";
                        ...
                        for (int j = 0; j < materials.Length; j++)
                        {
                            ...
                            if (metaPassIndex != -1)
                            {
                                ...
                                if(performDilation)
                                {
                                    ...
                                    dilate.SetTexture(ComputeShader_Dilation, ShaderIDs.Write, materialMetaData.albedoBuffer);
                                ...
                                {
                                    //reuse the same buffer, the compute shader will modify the values of this render target.
                                    dilate.SetTexture(ComputeShader_Dilation, ShaderIDs.Write, materialMetaData.emissiveBuffer);
        ...
        public void RenderScene(List<ObjectMetaData> sceneObjectMetaData, Camera camera, RenderTexture renderTexture, int renderPassIndex)
        {
